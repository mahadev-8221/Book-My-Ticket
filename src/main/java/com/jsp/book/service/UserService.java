...
public interface UserService {
	...
	String searchMovies(String query, ModelMap map);

	String login(@Valid LoginDto dto, BindingResult result, RedirectAttributes attributes, HttpSession session);
	...
	String forgotPassword(@Valid ForgotPasswordDto forgotPasswordDto, BindingResult result,
			RedirectAttributes attributes);

	String loadForgotPassword(ForgotPasswordDto forgotPasswordDto);
	...
	String saveSeats(Long id, SeatLayoutForm seatLayoutForm, BindingResult result, HttpSession session,
			RedirectAttributes attributes);
	...
	String viewBookings(HttpSession session, ModelMap map, RedirectAttributes attributes);

	String viewUserBookings(Long userId, HttpSession session, ModelMap map, RedirectAttributes attributes);

	void completeBooking(String orderId, String paymentId);

	String manageAllBookings(HttpSession session, ModelMap map, RedirectAttributes attributes);

	String approveBooking(Long id, HttpSession session, RedirectAttributes attributes);

	String rejectBooking(Long id, HttpSession session, RedirectAttributes attributes);
}
